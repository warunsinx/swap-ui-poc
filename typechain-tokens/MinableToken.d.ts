...
interface MinableTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "maxElapsed()": FunctionFragment;
    "mine()": FunctionFragment;
    "mineBKNext(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "maxElapsed",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "mine", values?: undefined): string;
  encodeFunctionData(functionFragment: "mineBKNext", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "faucetRate", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getMiningReward",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "maxElapsed", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "mine", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "mineBKNext", data: BytesLike): Result;
...
export class MinableToken extends BaseContract {
  ...
  interface: MinableTokenInterface;
  ...
  functions: {
    ...
    faucetRate(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    maxElapsed(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  getMiningReward(user: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    mineBKNext(_bitkubnext: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    faucetRate(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    maxElapsed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
