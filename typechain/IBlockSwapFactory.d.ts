...
interface IBlockSwapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IBlockSwapFactory extends BaseContract {
  ...
  interface: IBlockSwapFactoryInterface;
