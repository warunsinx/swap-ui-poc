...
interface IBlockSwapRouter01Interface extends ethers.utils.Interface {
  functions: {
...
export class IBlockSwapRouter01 extends BaseContract {
  ...
  interface: IBlockSwapRouter01Interface;
