...
interface IBlockSwapRouter02Interface extends ethers.utils.Interface {
  functions: {
...
export class IBlockSwapRouter02 extends BaseContract {
  ...
  interface: IBlockSwapRouter02Interface;
