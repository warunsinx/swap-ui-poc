...
interface BlockSwapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class BlockSwapFactory extends BaseContract {
  ...
  interface: BlockSwapFactoryInterface;
